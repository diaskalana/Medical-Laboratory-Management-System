  ...
  const onFinish = async (values) => {
    try {
      ...
      if (selectedItemForEdit) {
        await axios.post(`${API_BASE_URL}/finance/edit-transaction`, {
          payload: {
            ...values,
            userid: user._id,
          },
        ...
        await axios.post(`${API_BASE_URL}/finance/add-transaction`, {
          ...values,
          userid: user._id,
        });
        getTransactions();
      ...
      >
        ...
        >
          <Select placeholder="Select transaction category">
            ...
            <Select.Option value="Blood/Urine Tests">
              Blood/Urine Tests
            </Select.Option>
            <Select.Option value="Ultrasound Scanning">
              Ultrasound Scanning
            </Select.Option>
            <Select.Option value="Physiotherapy">Physiotherapy</Select.Option>
            <Select.Option value="Other Income">Other Income</Select.Option>
            <Select.Option value="Employee Salary">
              Employee Salary
            </Select.Option>
            <Select.Option value="Equipment Purchase">
              Equipment Purchase
            </Select.Option>
